    ...
    function createProjectGroup(index) {
        ...
        group.innerHTML = `
            ...
            <div class="form-group">
                ...
                <textarea id="projectDescription${index}" name="projectDescription${index}" rows="3" maxlength="300"></textarea>
                <div class="char-counter" id="pd${index}Counter">0/300</div>
            </div>
    ...
    if (addBtn && extraContainer) {
        ...
        addBtn.addEventListener('click', function () {
            ...
            if (el && c) {
                ...
                const update = () => {
                    const val = el.value || '';
                    if (val.length > max) el.value = val.slice(0, max);
...
// Live character counters for project descriptions
function initProjectDescriptionCounters() {
    const inputs = [
        { id: 'projectDescription1', counter: 'pd1Counter', max: 300 },
        { id: 'projectDescription2', counter: 'pd2Counter', max: 300 },
        { id: 'projectDescription3', counter: 'pd3Counter', max: 300 }
    ];
...
function validateForm(formData) {
    ...
    // Check if at least 3 logos are selected
    if (selectedLogos.length < 3) {
        alert('Please select at least 3 logos from the available options.');
        return false;
    }
    ...
    <div class="resume-container" id="resume-content">
        ...
        <div class="footer">
            <div class="footer-content">
                <div class="footer-bold">Alliance School of Advanced Computing | Faculty of Engineering and Technology</div>
